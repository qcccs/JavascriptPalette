...
import org.netbeans.modules.filepalette.items.If;
 ...
 * @author Ian
 */
public class IfPopup extends javax.swing.JPanel {
     ...
     * @param target  
     */
    public IfPopup(If item, JTextComponent target) {
        this.ifitem = item;
        this.target = target;
        initComponents();
    ...
    private void initComponents() {
        ...
        ifBody.setRows(5);
        ifBody.setText(org.openide.util.NbBundle.getMessage(IfPopup.class, "IfPopup.ifBody.text")); // NOI18N
        jScrollPane1.setViewportView(ifBody);

        org.openide.awt.Mnemonics.setLocalizedText(jLabel12, org.openide.util.NbBundle.getMessage(IfPopup.class, "IfPopup.jLabel12.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(addIfStat, org.openide.util.NbBundle.getMessage(IfPopup.class, "IfPopup.addIfStat.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel27, org.openide.util.NbBundle.getMessage(IfPopup.class, "IfPopup.jLabel27.text")); // NOI18N
